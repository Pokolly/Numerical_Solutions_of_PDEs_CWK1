...
for i=1:number_of_timesteps %places our 1st initial condition for x in the first column
    M(i,1) = initialcondition_x_1 ; 
end
    
for i=1:number_of_timesteps %places our final initial conditions for x in the final column
    M(i,N+1) = initialcondition_x_2 ;
end
...
%which is the PDE ibe for iterating to calculate the rest of the terms in
%the matrix. 
